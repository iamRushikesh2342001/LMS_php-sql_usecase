...
.rightinnerdiv {
    float: right;
   width: calc(75% - 20px); /* Calculate the width of the rightinnerdiv */
  /* The 20px is the left margin of the input element */
}
...
.logo-container {
  margin-right: -200px; /* add some space between logo and photo */
  margin-left: 250px; /* move logo to the right */
  margin-bottom: -15px;
  margin-top:-60px;
}
...
elseif($msg=="fail"){
    ...
    ?>
        ...
        <div class="photo-container">
            ...
            <!-- <div class="row"><img class="imglogo" src="images/logoDL1.jpg"/></div> -->
            <div class="leftinnerdiv">
                ...
                <Button class="greenbtn" onclick="openpart('bookreport')" > <img class="icons" src="images/icon/open-book.png" width="30px" height="30px"/> BOOKS RECORD</Button>
                ...
                <Button class="greenbtn" onclick="openpart('issuebookreport')"> <img class="icons" src="images/icon/checklist.png" width="30px" height="30px"/> CHECKOUTS</Button>
                <!-- <a href="index.php"><Button class="greenbtn" ><img class="icons" src="images/icon/book.png" width="30px" height="30px"/> LOGOUT</Button></a> -->
                <a href="index.php"><Button class="greenbtn" ><img class="icons" src="images/icon/logout.png" width="30px" height="30px"/></Button></a>
            </div>
            ...
            padding: 8px;'>Student Name</th><th>Book Name</th><th>Requested_days </th><th>Approve</th></tr>";
            ...
            <label class="form-label-bookname">Book Name :</label><input type="text" name="bookname" class="input-field"/>
            </br>
            <label class="form-label-detail">Detail :</label><input  type="text" name="bookdetail" class="input-field"/></br>
            <label class="form-label-author" >Author :</label><input type="text" name="bookaudor" class="input-field"/></br>
            <label class="form-label-publication">Publication :</label><input type="text" name="bookpub" class="input-field"/></br>
            ...
            <label class="form-label-price">Price :</label><input  type="number" name="bookprice" class="input-field"/></br>
            <label class="form-label-quantity">Quantity :</label><input type="number" name="bookquantity" class="input-field"/></br>
            ...
            <label class="form-label-bookname">Name :</label><input type="text" name="addname" class="input-field"/>
            </br>
            <label class="form-label-pass">Password :</label><input type="pasword" name="addpass" class="input-field"/>
            </br>
            <label class="form-label-bookname">Email :</label><input  type="email" name="addemail" class="input-field"/></br>
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                $table.="<td>$row[2]</td>";
                // $table.="<td>$row[4]</td>";
                $table.="<td><a href='deleteuser.php?useriddelete=$row[0]'><button type='button' class='btn btn-primary'>Delete</a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
            $table.="</table>";
...
<!-- checkouts -->
            ...
            <Button class="greenbtn" >CHECKOUTS</Button>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style='  
            padding: 8px;'>Student Name</th><th>Book Name</th><th>Issue Date</th><th>Return Date</th></tr>";
            ...
            foreach($recordset as $row){
               ...
               "<td>$row[0]</td>";
                ...
                // $table.="<td>$row[8]</td>";
                // $table.="<td>$row[4]</td>";
                // $table.="<td><a href='returnbook.php?bookid=$row[0]&userid=$userloginid'><button type='button' class='btn btn-primary'>Return</button></a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
            $table.="</table>";
...
<br>
           <label class="form-label-day">Days</label> <input type="number" name="days" class="input-field-day"/>
           <br>
...
?>
            ...
            $table="<table style='font-family: Arial, Helvetica, sans-serif;border-collapse: collapse;width: 100%;'><tr><th style=' 
            padding: 8px;'>Book Name</th><th>Price</th><th>Qnt</th><th>Available</th><th>View</th></th><th>Delete</th></tr>";
            foreach($recordset as $row){
                $table.="<tr>";
               "<td>$row[0]</td>";
                $table.="<td>$row[2]</td>";
                ...
                $table.="<td>$row[9]</td>";
                // $table.="<td>$row[10]</td>";
                $table.="<td><a href='admin_service_dashboard.php?viewid=$row[0]'><button type='button' class='btn btn-primary'>View</button></a></td>";
                $table.="<td><a href='deletebook_dashboard.php?deletebookid=$row[0]'><button type='button' class='btn btn-primary'>Delete</a></td>";
                $table.="</tr>";
                // $table.=$row[0];
            }
            $table.="</table>";
