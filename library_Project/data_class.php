...
class data extends db {
    ...
    function addbook($bookname, $bookdetail, $bookaudor, $bookpub, $bookprice, $bookquantity) {
    ...
    function requestbook($userid,$bookid){
        ...
        if($this->connection->exec($q)) {
            header("Location:otheruser_dashboard.php?userlogid=$userid&msg=request done");
        }
    ...
    function returnbook($id){
        ...
        if($this->connection->exec($q)){
            ...
            header("Location:otheruser_dashboard.php?userlogid=$userlogid");
         }
        //  else{
        //     header("Location:otheruser_dashboard.php?msg=fail");
        //  }
